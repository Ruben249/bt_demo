...
> These packages were developed and validated on **Ubuntu 22.04 (Jammy)** and ROS2 rolling. They can be executed either **natively** on Ubuntu 22.04 or inside an **Ubuntu 22.04 Distrobox** container (recommended when isolating dependencies or
## License
